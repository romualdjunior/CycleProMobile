...
import Forms.Commande.BraintreeNative;
import Forms.Commande.BraintreePaymentCallback;
...
public class Purchase {
    ...
    static boolean flag;
    static Resources theme = UIManager.initNamedTheme("/theme", "Theme1");
    ...
    public static void startOrder(Callback callback) {
        ...
        if (bn != null && bn.isSupported()) {
            ...
            BaseForm buy =  new BaseForm(new BorderLayout());
            ...
            buy.installSidemenu(theme, list_button, list_form);
            ...
            cmp.setPage("<html><head>"
                    ...
                    + "\n"
                    + "  <label for=\"card-number\" style=\"font-size:82px;\">Card Number</label>\n"
                    + "  <div style=\"font-size:82px;\" class=\"hosted-field\" id=\"card-number\"></div>\n"
                    + "\n"
                    + "  <label style=\"font-size:82px;\" for=\"cvv\">CVV</label>\n"
                    + "  <div class=\"hosted-field\" style=\"font-size:82px;\" id=\"cvv\"></div>\n"
                    + "\n"
                    + "  <label style=\"font-size:82px;\" for=\"expiration-date\">Expiration Date</label>\n"
                    + "  <div style=\"font-size:82px;\" class=\"hosted-field\" id=\"expiration-date\"></div>\n"
                    + "\n"
                    + "  <input type=\"hidden\" name=\"payment_method_nonce\">\n"
                    + "  <input type=\"submit\" style=\"font-size:82px;\" value=\"Pay\" disabled>\n"
                    + "</form>\n"
                    + "\n"
