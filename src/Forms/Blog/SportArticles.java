 ...
 * @author asus
 */
public class SportArticles extends BaseForm{
  Form f;
Resources res=UIManager.initNamedTheme("/theme", "Theme1");
    public SportArticles(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        ArrayList<Article> p = rs.getSportArticles();
