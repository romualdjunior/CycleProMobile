 ...
 * @author asus
 */
public class NutritionArticles extends BaseForm{
  Form f;
Resources res=UIManager.initNamedTheme("/theme", "Theme1");
    public NutritionArticles(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setTitle("BLOG NUTRITION" );
        
        ArticleService rs = new ArticleService();
        ArrayList<Article> p = rs.getNutritionArticles();
