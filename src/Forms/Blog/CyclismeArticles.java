 ...
 * @author asus
 */
public class CyclismeArticles extends BaseForm{
  Form f;
Resources res=UIManager.initNamedTheme("/theme", "Theme1");
    public CyclismeArticles(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setTitle("BLOG CYCLISME");
        
        ArticleService rs = new ArticleService();
        ArrayList<Article> p = rs.getCyclismeArticles();
