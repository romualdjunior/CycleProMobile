 ...
 * @author asus
 */
public class FavoritArticles extends BaseForm{
  Form f;
Resources res=UIManager.initNamedTheme("/theme", "Theme1");
    public FavoritArticles(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        list_form.add(new SportArticles(resourceObjectInstance));
        list_form.add(new BienArticles(resourceObjectInstance));
        list_form.add(new NutritionArticles(resourceObjectInstance));
        list_form.add(new CyclismeArticles(resourceObjectInstance));
