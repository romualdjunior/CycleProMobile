 ...
 * @author toshiba
 */
public class SignIn extends com.codename1.ui.Form {
  String tmp="";
    public SignIn() {
            ...
            if ((gui_username.getText().length() == 0) || (gui_password.getText().length() == 0)) {
                ...
                try {
                    ...
                    if (tmp.startsWith("Utilisateur existant")) {
                        Dialog.show("SUCCESS", tmp, "OK", null);
                    } else {
                        Dialog.show("ERROR", tmp, "OK", null);
                    }
    ...
    public SignIn(com.codename1.ui.util.Resources resourceObjectInstance) {
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        gui_username.setPreferredSizeStr("61.640213mm 9.259259mm");
        ...
        ((com.codename1.ui.layouts.LayeredLayout)gui_username.getParent().getLayout()).setInsets(gui_username, "auto 3.4391537mm 30.018085% 0.0mm").setReferenceComponents(gui_username, "-1 -1 -1 2 ").setReferencePositions(gui_username, "0.0 0.0 0.0 0.0");
        ((com.codename1.ui.layouts.LayeredLayout)gui_password.getParent().getLayout()).setInsets(gui_password, "1.3227539mm 1.3227514mm 70.55215% 0.0mm").setReferenceComponents(gui_password, "4 4 -1 2 ").setReferencePositions(gui_password, "1.0 0.0 0.0 0.0");
        ((com.codename1.ui.layouts.LayeredLayout)gui_login .getParent().getLayout()).setInsets(gui_login , "2.910057mm 1.8518519mm 54.62963% 1.3227513mm").setReferenceComponents(gui_login , "5 4 -1 2 ").setReferencePositions(gui_login , "1.0 0.0 0.0 0.0");
